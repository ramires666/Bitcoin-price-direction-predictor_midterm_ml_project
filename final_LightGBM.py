...
def run_training_pipeline():
   ...
   при этом ВСЕ индикаторы и объёмные фичи сдвигаются на 1 назад (используем историю до t-1).
    ...
    Это LightGBM-вариант исходного пайплайна на XGBoost с максимально сохранённой структурой.
    """
...
if __name__ == "__main__":
    ...
    # Для запуска:
    #   python final_LightGBM.py
    #
    # или:
    #   from final_LightGBM import run_training_pipeline
    #   run_training_pipeline()
    run_training_pipeline()